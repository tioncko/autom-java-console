...
public class BKP_MetodosUsuario extends Usuario {
     ...
     * Construtor
     */
    public BKP_MetodosUsuario() {
        this.tabUsuario = new HashMap<>();
    }
    public BKP_MetodosUsuario(BKP_MetodosUsuario usr) {
...
*/
    ...
    public boolean validUsuario(String login, BKP_MetodosUsuario dt) {
        boolean valid = false;
     ...
     */
    public boolean validLoginUsuario(String login, String pass, BKP_MetodosUsuario dt) {
        boolean valid = false;
        this.tabUsuario = dt.tabUsuario;
    ...
    public Integer UserId(String access, BKP_MetodosUsuario dt) {
        this.tabUsuario = dt.tabUsuario;
        Integer retrn = null;
