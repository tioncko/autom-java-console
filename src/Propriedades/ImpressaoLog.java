    ...
    public static class LogFormatter extends Formatter {
        ...
        public String format(LogRecord record) {
            ...
            switch (record.getLevel().getName()) {
                case "INFO":
                    sb.append(ANSI_Levels.ANSI_CYAN.getLevel());
                ...
                case "WARNING":
                    sb.append(ANSI_Levels.ANSI_YELLOW.getLevel());
                    sb.append("[").append(DateFormat(record.getMillis())).append("] ");
                    sb.append("[").append(record.getLevel().getName()).append("] ");
                    sb.append(record.getMessage());
                    break;
                ...
                case "SEVERE":
                    sb.append(ANSI_Levels.ANSI_RED.getLevel());
                    sb.append("[").append(DateFormat(record.getMillis())).append("] ");
                    sb.append("[").append(record.getLevel().getName()).append("] ");
                    sb.append(record.getMessage());
                    break;
            ...
            sb.append(ANSI_Levels.ANSI_RESET.getLevel());
            sb.append("\n");
            return sb.toString();
        }
